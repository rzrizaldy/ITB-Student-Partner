...
<head>
    ...
    <title>Kalender Akademik ITB 2016/2017</title>
    <h1 align = "center">
		<img src='itb.png'>
	</h1>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1>Kalender Akademik ITB</h1>
                <p class="lead">Tahun Ajaran 2016/2017</p>
		  ...
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="addEvent.php">
			  ...
			  <div class="modal-body">
				  ...
				  <div class="form-group">
					<label for="start" class="col-sm-2 control-label">Tanggal mulai</label>
					<div class="col-sm-10">
